                                ...
                                wl_fixed_t sy)
{
    ...
    switch (window->wl.decorations.focus)
    {
        ...
        case bottomDecoration:
            ...
            else if (x > window->wl.scr_width + _GLFW_DECORATION_WIDTH)
    ...
    if (button == BTN_LEFT)
    {
        switch (window->wl.decorations.focus)
        {
            ...
            case bottomDecoration:
                ...
                else if (window->wl.cursorPosX > window->wl.scr_width + _GLFW_DECORATION_WIDTH)
