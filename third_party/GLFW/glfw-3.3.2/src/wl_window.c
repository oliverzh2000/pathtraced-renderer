...
static void createDecorations(_GLFWwindow* window)
{
    ...
    createDecoration(&window->wl.decorations.top, window->wl.surface,
                     ...
                     window->wl.scr_width, _GLFW_DECORATION_TOP);
    ...
    createDecoration(&window->wl.decorations.bottom, window->wl.surface,
                     ...
                     window->wl.scr_width + _GLFW_DECORATION_HORIZONTAL, _GLFW_DECORATION_WIDTH);
}
...
static void setOpaqueRegion(_GLFWwindow* window)
{
    ...
    wl_region_add(region, 0, 0, window->wl.scr_width, window->wl.height);
...
static void resizeWindow(_GLFWwindow* window)
{
    ...
    int scaledWidth = window->wl.scr_width * scale;
                              ...
                              const _GLFWwndconfig* wndconfig)
{
    ...
    window->wl.scr_width = wndconfig->width;
                           ...
                           _GLFWcursorWayland* cursorWayland)
{
    ...
    else
    {
        ...
        cursorWayland->scr_width = image->scr_width;
    ...
    wl_surface_damage(surface, 0, 0,
                      cursorWayland->scr_width, cursorWayland->height);
                              ...
                              int xhot, int yhot)
{
    ...
    cursor->wl.scr_width = image->width;
