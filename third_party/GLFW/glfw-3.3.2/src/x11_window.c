                                   ...
                                   Visual* visual, int depth)
{
    ...
    _glfwPlatformGetWindowSize(window, &window->x11.scr_width, &window->x11.height);
...
static void processEvent(XEvent *event)
{
    ...
    switch (event->type)
    {
        ...
        {
            if (event->xconfigure.scr_width != window->x11.scr_width ||
                event->xconfigure.height != window->x11.height)
            {
                _glfwInputFramebufferSize(window,
                                          event->xconfigure.scr_width,
                ...
                window->x11.scr_width = event->xconfigure.scr_width;
