...
#ifndef PATHTRACED_RENDERER_RENDER_PRIMITIVE_GROUP_H
#define PATHTRACED_RENDERER_RENDER_PRIMITIVE_GROUP_H
...
#endif //PATHTRACED_RENDERER_RENDER_PRIMITIVE_GROUP_H
